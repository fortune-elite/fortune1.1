    ...
    return ( 
        <div className= " flex-row items-center  md:flex-row  lg:flex-row pt-0  md:pt-10 lg:pt-10 ">
            ...
            <div className=" flex flex-col md:flex-row px-14 space-y-8 space-x-0 md:space-y-0 md:space-x-8  lg:flex-row pt-0  md:pt-5 lg:pt-5">
                <div className="bg-blue-800 h-52 w-60 md:w-48 rounded-lg shadow-sm overflow-hidden hover:bg-blue-700">
                ...
                <div className="bg-blue-500 h-52 w-60 md:w-48   rounded-lg shadow-sm   overflow-hidden hover:bg-blue-400">
                ...
                <div className="bg-gray-800 h-52 w-60 md:w-48  rounded-lg shadow-sm overflow-hidden hover:bg-gray-700">
