...
const BetterWay = () => {
    return ( 
        <div className=" bg-gray-200 flex flex-col items-center space-x-8  md:flex-col px-5 lg:flex-row pt-0 px-5 md:pt-10 lg:pt-10">
            <div className="px-5"> 
                <h1 className="text-4xl py-2 font-medium text-black">A better way to invest your money and make it grow.</h1>
                <p className="text-sm py-2">Fortune helps customers to achieve their monetary gooals by helping them save & invest . Fissure bills. Obtaining a loan. Control your money with spending analytics. </p>
            ...
            <div>
                <img className=" h-85 w-85" src="/Woman.png" />
            </div>
